...
const findRestaurant = (rest_name, address1, city, state, country) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const response = yield axios_1.default.get(yelpUrl, { headers, params });
